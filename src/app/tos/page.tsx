...
export default function ToS() {
  return (
    <div className="text-white container py-32 mx-32">
      ...
      <p>
        By accessing this Website, accessible from https://www.hashcase.co/, you
      ...
      <p>
        ...
        on HashCase's Website for personal, non-commercial transitory viewing
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on HashCase's
          Website;
        </li>
        <li>
      ...
      <p>
        This will let HashCase to terminate upon violations of any of these
      ...
      <p>
        All the materials on HashCase’s Website are provided "as is". HashCase
        makes no warranties, may it be expressed or implied, therefore negates
        all other warranties. Furthermore, HashCase does not make any
      ...
      <p>
        HashCase or its suppliers will not be hold accountable for any damages
        that will arise with the use or inability to use the materials on
        HashCase’s Website, even if HashCase or an authorize representative of
      ...
      <p>
        The materials appearing on HashCase’s Website may include technical,
        typographical, or photographic errors. HashCase will not promise that
        any of the materials in this Website are accurate, complete, or current.
        HashCase may change the materials contained on its Website at any time
        without notice. HashCase does not make any commitment to update the
        materials.
      </p>
      ...
      <p>
        HashCase has not reviewed all of the sites linked to its Website and is
        not responsible for the contents of any such linked site. The presence
        of any link does not imply endorsement by HashCase of the site. The use
      ...
      <p>
        HashCase may revise these Terms of Use for its Website at any time
        without prior notice. By using this Website, you are agreeing to be
        bound by the current version of these Terms and Conditions of Use.
      </p>

      <h2 className="text-2xl font-semibold mt-8 mb-4">8. Your Privacy</h2>
      ...
      <p>
        Any claim related to HashCase's Website shall be governed by the laws of
